...
http header의 보완을 도와줘서 helmet인가봄 ㅋㅋ 네이밍 센스 좋다

silver bullet이란?
소프트웨어 공학 분야에 있어서는 프레더릭 브룩스가 1986년에 발표한 논문에 No Silver Bullet[1] 이라는 말을 사용,<br>
**모든 문제에 통용되는 만능 해결책 따위는 존재하지 않는다**고 논하였는데,<br>
이는 이상적인 소프트웨어 설계에 대해 부정적인 의미로 사용되는 경우가 많다.

[helmet](https://www.npmjs.com/package/helmet)
[production issue](https://expressjs.com/ko/advanced/best-practice-security.html)
